...
\begin{enumerate}\packed
    \item \TT{git commit -am 'msg'}
    \item \TT{git commit -\:-amend} \hspace{12pt}{\footnotesize Replaces last commit to include the updates \& changes the commit msg}
    \item\TT{git branch -m <name>}  \hspace{12pt}{\footnotesize Rename the current branch}
\end{enumerate}
\par \TT{git merge <master> <branchName>} 
